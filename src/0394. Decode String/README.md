...
The encoding rule is: `k[encoded_string]`, where the encoded*string inside the square brackets is being repeated exactly \_k* times. Note that _k_ is guaranteed to be a positive integer.
